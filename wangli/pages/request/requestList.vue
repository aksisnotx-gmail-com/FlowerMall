					...
					>
						...
						<view class="item-right c-list">
							...
							<view class="c-row b-b">
								...
								<view class="con">
									<switch :checked="item.publish == '1'" style="transform:scale(0.9)" @change="switchChange(item)"></switch>
								</view>
							</view>
							<view class="c-row b-b">
							...
							<view class="c-row b-b">
								<view class="con" v-if="item.status == '3'">
									<uni-icons type="weixin" size="30" color="#a6e7f1" @click="shareRequest(item)"></uni-icons>
								</view>
								<view class="con">
									<uni-icons type="trash" size="30" color="#a6e7f1" @click="deleteRequest(item.id)"></uni-icons>
								</view>
							</view>
						</view>
					</view>
