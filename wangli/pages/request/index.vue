<template>
	<view class="container">
		...
		<view class="f-header m-t">
			<view class="s-header">
				<image src="/static/temp/address.png"></image>
		...
		<view class="hot-floor">
			<view class="floor-img-box">
				<image class="floor-img" src="@/static/user-bg.jpg" mode="scaleToFill"></image>
			</view>
...
<script>
	...
	import {getLatesInfo,getRequestInfoList} from '@/api/request/index.js'
	export default {
		components:{
            pickerAddress
        },
