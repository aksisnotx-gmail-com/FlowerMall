			...
			<view class="top-title-container" :style="{backgroundColor:product.backgroundColor,background:'url('+product.background+')'}">
				...
				<view class="top-title-info">
					<view class="top-title-list" :style="{backgroundColor:product.backgroundColor}">
						...
						<view class="top-title-row b-b">
							<text class="top-title-tit" :style="{color:product.tagColor}">创建者：</text>
							<text class="top-title-text" :style="{color:product.contentColor}">{{product.createUserName}}</text>
						</view>
					</view>
				</view>
			</view>
...
<script>
	...
	import {getProductInfo} from "@/api/public/product/productViewDetail.js"
