	...
	<view class="container">
		...
		<view class="c-list">
			<view class="c-row b-b">
				...
				<view class="con">
					<uni-icons type="more" size="30" color="#a6e7f1" @click="goRequestDetail(request.id)"></uni-icons>
				</view>
				<text class="tit">所属流程</text>
				<view class="con">
					<uni-icons type="paperplane-filled" size="30" color="#a6e7f1" @click="goProcessList(request.id)"></uni-icons>
				</view>
			</view>
		</view>
		<view class="c-list">
...
<script>
	...
	export default{
		...
		methods:{
			goProcessList(id){
				uni.navigateTo({
					url: `/pages/process/processList_user?requestId=${id}`
				})
			},
			goRequestDetail(id){
				uni.navigateTo({
					url: `/pages/request/requestViewDetail_user?id=${id}`
				})
			},
			viewProduct(id){
				uni.navigateTo({
