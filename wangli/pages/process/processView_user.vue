<template>
	<view class="container">
		...
		<view class="c-list" v-if="formData.length > 0 && formData[this.type].requestList != undefined && formData[type].requestList.length != 0" >
...
<script>
	...
	export default{
		...
		methods:{
			...
			goDetail(id){
				uni.navigateTo({
					url: `/pages/process/processViewDetail?id=${id}`
				})
			}
		},
	}
