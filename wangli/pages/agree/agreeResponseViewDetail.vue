<template>
	<view class="container">
				...
				<view class="top-title-info">
					<view class="top-title-list">
						...
						<view class="top-title-row b-b">
							...
							<text class="top-title-text">{{response.createUserName}}</text>
						</view>
						<view class="top-title-row b-b">
		...
		<view class="c-list">
			...
			<view>
				<text class="c-row" style="background: white;">{{code}}</text>
			</view>
		</view>
		<!-- 底部操作菜单 -->
...
<script>
	import {getResponseDetail} from "@/api/sign/sign.js"
	export default{
		data() {
			return {
				response:{
		...
		async onLoad(options){
			await getResponseDetail(options.id).then(response => {
